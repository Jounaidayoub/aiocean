...
function FieldLegend({
  ...
  return (
    <legend
      ...
      className={cn(
        "mb-1 font-medium data-[variant=label]:text-xs data-[variant=legend]:text-sm text-foreground",
        className
      )}
      {...props}
    />
...
function FieldTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="field-label"
      className={cn(
        "flex w-fit items-center gap-2 text-xs font-semibold group-data-[disabled=true]/field:opacity-50",
        className
      )}
      {...props}
    />
...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        "text-left text-xs leading-normal font-normal text-muted-foreground group-has-data-horizontal/field:text-balance [[data-variant=legend]+&]:-mt-1",
